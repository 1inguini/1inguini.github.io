              ...
              body_ $ do
                ...
                section "コメント欄" $
                  form_
                      ...
                      onsubmit_ $
                        T.unlines
                          [ "var req = new XMLHttpRequest ();",
                            ...
                            "  }else{",
                            "    document.getElementById(\"commentTextarea\").value='コメント送信中...';",
                            "  }",
                            "}",
                            "",
                            "req.send(",
                            ...
                            -- "  + '&fields[email]=' + encodeURIComponent(document.commentForm.fields[email].value)",
                    ...
                    $ do
                      label_ $ "ハンドルネーム" <> input_ [name_ "name", type_ "text"]
                      label_ $ "E-Mail(Optional)" <> input_ [name_ "email", type_ "email"]
                      textarea_ [id_ "commentTextarea", name_ "message", rows_ "10", cols_ "100", placeholder_ "マサカリを投げる"] (pure ()) :: WebpageBody protocol ()
